    ...
    private void botonAceptarActionPerformed(java.awt.event.ActionEvent evt) {                                             
        ...
        if(rutValido){
            if(!esVacio){
                ...
                int dialogResult = JOptionPane.showConfirmDialog(rootPane, "Esta seguro que desea mpdificar el cliente");
                if(dialogResult == JOptionPane.YES_OPTION){
                    if(miControladorMC.irVistaControlClientes()) setVisible(false);
                }
            }
        }
    }                                            
