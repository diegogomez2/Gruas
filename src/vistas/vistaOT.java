 ...
 * @author Diego
 */
public class vistaOT extends javax.swing.JFrame {

    /**
     * Creates new form vistaOT
     */
    public vistaOT(String tipo, Object[][] data) {
        initComponents();
        setLocationRelativeTo(null);
        String[] list = new String[data.length];
        for(int i = 0; i < data.length; i++){
            list[i] = data[i][0].toString();
        }
        comboEmpleado.setModel(new DefaultComboBoxModel(list));
    }
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(comboEmpleado, javax.swing.GroupLayout.PREFERRED_SIZE, 163, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(23, 23, 23))
        );
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        controladores.controladorOT miControlador = new controladores.controladorOT();
        miControlador.irVistaIngresarOT();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vistaOT.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
