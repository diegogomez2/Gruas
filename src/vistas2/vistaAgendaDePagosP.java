...
import controladores2.controladorAgendaDePagos;
 ...
 * @author diego
 */
public class vistaAgendaDePagosP extends javax.swing.JPanel {

    /****CUSTOMIZE CODE TABLA****/
//    @Override
...
//        Object value = getModel().getValueAt(row, 5);
//        Date fec;
//        try{
//            fec = formatDate.parse(value.toString());
...
//        }
//        value = getModel().getValueAt(row, 6);
