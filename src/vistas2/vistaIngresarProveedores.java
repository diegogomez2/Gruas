...
import vistas.*;
import controladores2.controladorIngresarProveedores;
 ...
 * @author diego
 */
public class vistaIngresarProveedores extends javax.swing.JDialog {

    /**
     * Creates new form IC
     */
    public vistaIngresarProveedores(java.awt.Frame parent, boolean modal, final Object[][] regiones) {
        super(parent, modal);
        initComponents();
    ...
    public void cargarComunas(Object[][] regiones){
        controladorIngresarProveedores miControlador = new controladorIngresarProveedores();
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(comboRegion, 0, 359, Short.MAX_VALUE)
    ...
    private void botonAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonAceptarActionPerformed
        controladorIngresarProveedores miControladorIP = new controladorIngresarProveedores();
        String respuesta = miControladorIP.camposVacios();
        ...
        if (!esVacio) {
            ...
            boolean rutValido = miControladorIP.verificarRut(getTextoRut());
            if (rutValido) {
                if (miControladorIP.irVistaProveedoresP()) {
                    setVisible(false);
                }
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vistaIngresarProveedores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
