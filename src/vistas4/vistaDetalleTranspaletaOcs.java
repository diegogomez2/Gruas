 ...
 * @author diego
 */
public class vistaDetalleTranspaletaOcs extends javax.swing.JDialog {

    DateFormat formatDate = new SimpleDateFormat("yyyy-MM-ddd");
    NumberFormat FORMAT = NumberFormat.getCurrencyInstance();
    DecimalFormatSymbols dfs = new DecimalFormatSymbols();
    
    public vistaDetalleTranspaletaOcs(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel11.setText("Número de transpaletas");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vistaDetalleTranspaletaOcs.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                vistaDetalleTranspaletaOcs dialog = new vistaDetalleTranspaletaOcs(new javax.swing.JFrame(), true);
