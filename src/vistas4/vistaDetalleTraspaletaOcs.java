 ...
 * @author diego
 */
public class vistaDetalleTraspaletaOcs extends javax.swing.JDialog {

    DateFormat formatDate = new SimpleDateFormat("yyyy-MM-ddd");
    NumberFormat FORMAT = NumberFormat.getCurrencyInstance();
    DecimalFormatSymbols dfs = new DecimalFormatSymbols();
    
    public vistaDetalleTraspaletaOcs(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vistaDetalleTraspaletaOcs.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                vistaDetalleTraspaletaOcs dialog = new vistaDetalleTraspaletaOcs(new javax.swing.JFrame(), true);
