...
public class vistaDetalleFacturadasOC extends javax.swing.JDialog {

    DefaultTableModel datos;
    /**
     * Creates new form vistaDetalleFacturas
     */
    public vistaDetalleFacturadasOC(java.awt.Frame parent, boolean modal, Object[][] data) {
        super(parent, modal);
        initComponents();
        String[] columNames = {"Código OC", "Razon", "Giro", "Dirección", "Ciudad", "Comuna", "Fecha",
            "Neto", "IVA", "Total"};
        ...
        if(tablaOcs.getRowCount() > 0) tablaOcs.setRowSelectionInterval(0, 0);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vistaDetalleFacturadasOC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
