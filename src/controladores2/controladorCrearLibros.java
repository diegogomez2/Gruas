...
public class controladorCrearLibros {
    ...
    public boolean crearLibroCompras(){
        ...
        try{
            ...
            fechaRes.appendChild(doc.createTextNode("FECHA RESOL VER"));
            Element numRes = doc.createElement("NroResol");
            numRes.appendChild(doc.createTextNode("NUM RESOL VER"));
            ...
            StreamResult result =   new StreamResult(new File("Libro compras prueba.xml"));
    ...
    public boolean crearLibroVentas(){
        ...
        try{
            ...
            transformer.setOutputProperty(OutputKeys.ENCODING, "ISO-8859-1");
            DOMSource source = new DOMSource(doc);
            StreamResult result =   new StreamResult(new File("Libro ventas prueba.xml"));
            transformer.transform(source, result);
            JOptionPane.showMessageDialog(null, "Documento realizado con éxito");
